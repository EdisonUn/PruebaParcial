...
import com.example.pruebaparcial.ml.Modelbanderas;
...
public class MainActivity extends AppCompatActivity implements OnSuccessListener<Text>, OnFailureListener, ImageReader.OnImageAvailableListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url ="http://www.geognos.com/api/en/countries/info/EC.json";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                txtResults.setText("No conecta con la API!");
                txtResults.setMovementMethod(new ScrollingMovementMethod());
            }
        });
...
protected void setFragment() {
    ...
    //En esta parte de codigo se realiza el reconocimiento de imagen en tiempo real
    private void processImage() {
        imageConverter.run();
